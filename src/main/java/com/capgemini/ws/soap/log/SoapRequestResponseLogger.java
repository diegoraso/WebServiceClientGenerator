 ...
 * @author diraso
 * 
 *         Classe che permette di loggare le richieste e le risposte dei web
 *         service SOAP sono previste due modalità operative: - log abilitato
 *         per tutti i servizi impostatndo le properties di sistema - log
 *         abilitato al singolo servizio specificato
 *
 */
public class SoapRequestResponseLogger {
	...
	/**
	 * impostati il log a livello sistema, quindi saranno loggati tutte le
	 * richieste e risposte. Da utilizzare prima di istanziare i servizi
	...
	/**
	 * associa handler al servizio per loggare le richieste e risposte soap del
	 * client specificato come parametro
	 * 
	 * @param service
	 */
